:: Version 2.4.0 - 29.08.2026 - @nurjns
...
echo Select Codec:
echo 1 - H.265 - Good compression, faster encoding, broad support (Default)
					...
					if !REMAINING! GEQ 1 (
						...
						if "%CRF_WERT%"=="" (
							...
							if "%CODECWAHL%"=="1" (
								...
								:: AV1 - dynamically determine cpu-used
								if !CRF_WERT! LEQ 20 (
									set "CPU_USED=2"
